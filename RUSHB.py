...
class Connection:
	...
	def switch_greeting_adapter(self, modified_test_name="SWITCH_GREETING_ADAPTER"):
		...
		sys.stderr.write(
			f"Run your switch with these argument:\n\t[./RUSHBSwitch | python3 RUSHBSwitch.py] local 192.168.1.1/24 0 2 > {modified_test_name}.bout\n")
		sys.stderr.flush()
	...
	def switch_local2_greeting(self, modified_test_name="SWITCH_LOCAL2_GREETING"):
		...
		sys.stderr.write(
			f"Run your switch with these argument:\n\t[./RUSHBSwitch | python3 RUSHBSwitch.py] local 10.0.0.1/8 130.0.0.1/8 2 2 > {modified_test_name}.b2out\n")
		sys.stderr.flush()
		file_path = f"{modified_test_name}.b2out"
